...
export function RenderResumeAddress() {
  return <p className="resume-address"></p>;
}

export function RenderResumeEmail() {
  return <p className="resume-email"></p>;
}

export function RenderResumeNumber() {
  return <p className="resume-number"></p>;
}

export function RenderResumeName() {
  return <h1 className="resume-name"></h1>;
}

export function RenderResumeJobTitle() {
  return <h2 className="resume-jobtitle"></h2>;
}
